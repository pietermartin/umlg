...
public class TestAssociationClassGremlin extends BaseLocalDbTest {
    ...
    public void testGremlinOnAssociationClass() {
        ...
        String edges = UMLG.get().executeQueryToJson(UmlgQueryEnum.GROOVY, human.getId(), "self.outE.hasAC('associationclass::org::umlg::tinkergraph::AssociationClassSetTest::weight', T.eq, 1)");
