...
public class GenerateTestProjects {
	...
	public static void main(String[] args) throws URISyntaxException {
        ...
        javaGenerator.generate(new File(args[0] + "/test/blueprints/umlg-test-blueprints/src/main/model/tinker-test.uml"), new File(args[0] + "/test/blueprints/umlg-test-blueprints/"), DefaultVisitors.getDefaultJavaVisitors());
		...
		javaGenerator = new JavaGenerator();
		javaGenerator.generate(new File(args[0] + "/test/umlg-test-basic/src/main/model/tinker-test-basic.uml"), new File(args[0] + "/test/umlg-test-basic/"), DefaultVisitors.getDefaultJavaVisitors());
		javaGenerator = new JavaGenerator();
