...
import org.tuml.sequence.SequenceNotUniqueRoot;
import org.tuml.sequence.SequenceNotUniqueTest;
...
public class TestSequence extends BaseLocalDbTest {
    ...
    public void testSequenceInverseLogic() {
        ...
        Assert.assertEquals(4 + 2, countVertices());
        Assert.assertEquals(8 + 2 + 4, countEdges());
    }
    ...
    public void testSequenceUsingIndexedPosition() {
        ...
        Assert.assertEquals(14 + 2 + 7, countEdges());
    }
    ...
    public void testSequenceRemovalInverse() {
        ...
        Assert.assertEquals(6 + 2 + 3, countEdges());
    ...
    public void testDuplicateRemoval2() {
        ...
        Assert.assertEquals(25 + 2 + 4, countEdges());
        ...
        Assert.assertEquals(22 + 2 + 4, countEdges());
        ...
        db.commit();
        Assert.assertEquals(8 + 2, countVertices());
        Assert.assertEquals(20 + 2 + 4, countEdges());
        ...
        Assert.assertEquals(8 + 2, countVertices());
        Assert.assertEquals(18 + 2 + 4, countEdges());
        ...
        Assert.assertEquals(15 + 2 + 3, countEdges());
