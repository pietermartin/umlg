...
public class Angel extends BaseTuml implements CompositionNode {
	...
	public void fromJson(Map<String,Object> propertyMap) {
		for ( String propertyName : propertyMap.keySet() ) {
			if ( propertyName.equals("rank") ) {
				setRank((Integer)propertyMap.get(propertyName));
	...
	static public enum AngelRuntimePropertyEnum implements TumlRuntimeProperty {
		rank(true,true,false,"basicmodel__org__tuml__qualifier__Angel__rank",false,false,true,false,1,1,false,false,false,false,true,"{\"rank\": {\"onePrimitive\": true, \"controllingSide\": true, \"composite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"label\": \"basicmodel__org__tuml__qualifier__Angel__rank\", \"qualified\": false, \"inverseQualified\": false, \"inverseOrdered\": false, \"unique\": true}}"),
		god(false,false,false,"A_<god>_<angel>",false,false,true,false,1,1,false,true,false,false,true,"{\"god\": {\"onePrimitive\": false, \"controllingSide\": false, \"composite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"label\": \"A_<god>_<angel>\", \"qualified\": false, \"inverseQualified\": true, \"inverseOrdered\": false, \"unique\": true}}"),
		name(true,true,false,"basicmodel__org__tuml__qualifier__Angel__name",false,false,true,false,1,1,false,false,false,false,true,"{\"name\": {\"onePrimitive\": true, \"controllingSide\": true, \"composite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"label\": \"basicmodel__org__tuml__qualifier__Angel__name\", \"qualified\": false, \"inverseQualified\": false, \"inverseOrdered\": false, \"unique\": true}}");
		 ...
		 * @param json 
		 */
		private AngelRuntimePropertyEnum(boolean onePrimitive, boolean controllingSide, boolean composite, String label, boolean oneToOne, boolean oneToMany, boolean manyToOne, boolean manyToMany, int upper, int lower, boolean qualified, boolean inverseQualified, boolean ordered, boolean inverseOrdered, boolean unique, String json) {
		...
		static public String asJson() {
			StringBuilder sb = new StringBuilder();;
			sb.append("{\"Angel\": [");
			sb.append(AngelRuntimePropertyEnum.rank.toJson());
			sb.append(",");
