...
public interface Interface2 extends CompositionNode {
	...
	public enum Interface2RuntimePropertyEnum implements TumlRuntimeProperty {
		...
		private String json;
		/**
		 * constructor for Interface2RuntimePropertyEnum
		 * 
		 * @param onePrimitive 
		 ...
		 * @param json 
		 */
		private Interface2RuntimePropertyEnum(boolean onePrimitive, boolean controllingSide, boolean composite, String label, boolean oneToOne, boolean oneToMany, boolean manyToOne, boolean manyToMany, int upper, int lower, boolean qualified, boolean inverseQualified, boolean ordered, boolean inverseOrdered, boolean unique, String json) {
		...
		static public String asJson() {
			...
			sb.append("[");
			sb.append(Interface2RuntimePropertyEnum.name.toJson());
			sb.append(",");
			sb.append(Interface2RuntimePropertyEnum.interface1.toJson());
			sb.append(",");
			sb.append("]");
			return sb.toString();
		}
		
		static public Interface2RuntimePropertyEnum fromLabel(String label) {
