...
public class SequenceTest extends BaseTuml implements CompositionNode {
	...
	static public enum SequenceTestRuntimePropertyEnum implements TumlRuntimeProperty {
		sequenceRoot(false,false,false,"A_<sequenceRoot>_<sequenceTest>",false,false,true,false,1,1,false,false,true,true,true,"{\"sequenceRoot\": {\"onePrimitive\": false, \"controllingSide\": false, \"composite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"label\": \"A_<sequenceRoot>_<sequenceTest>\", \"qualified\": false, \"inverseQualified\": false, \"inverseOrdered\": true, \"unique\": true}}"),
		name(true,true,false,"basicmodel__org__tuml__sequence__SequenceTest__name",false,false,true,false,1,1,false,false,false,false,true,"{\"name\": {\"onePrimitive\": true, \"controllingSide\": true, \"composite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"label\": \"basicmodel__org__tuml__sequence__SequenceTest__name\", \"qualified\": false, \"inverseQualified\": false, \"inverseOrdered\": false, \"unique\": true}}");
		...
		static public String asJson() {
			...
			sb.append(SequenceTestRuntimePropertyEnum.sequenceRoot.toJson());
			sb.append(",");
			sb.append(SequenceTestRuntimePropertyEnum.name.toJson());
			sb.append("]}");
			return sb.toString();
		}
