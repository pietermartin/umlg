...
public class Many extends BaseTinker implements CompositionNode {
	...
	public enum ManyRuntimePropertyEnum implements TumlRuntimeProperty {
		name(true,true,false,"tuml-test-basic-model__org__tuml__Many__name",false,false,true,false,1,1,false,false),
		one(false,false,false,"A_<one>_<many>",false,false,true,false,1,1,false,false);
		 ...
		 */
		private ManyRuntimePropertyEnum(boolean onePrimitive, boolean controllingSide, boolean composite, String label, boolean oneToOne, boolean oneToMany, boolean manyToOne, boolean manyToMany, int upper, int lower, boolean qualified, boolean inverseQualified) {
