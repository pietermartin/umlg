...
public class Time extends BaseTinker implements CompositionNode {
	...
	public enum TimeRuntimePropertyEnum implements TumlRuntimeProperty {
		name(true,true,false,"org__tinker__componenttest__Time__name",false,false,true,false,1,1,false,false,false,false,true),
		 ...
		 * @param unique 
		 */
		private TimeRuntimePropertyEnum(boolean onePrimitive, boolean controllingSide, boolean composite, String label, boolean oneToOne, boolean oneToMany, boolean manyToOne, boolean manyToMany, int upper, int lower, boolean qualified, boolean inverseQualified, boolean ordered, boolean inverseOrdered, boolean unique) {
