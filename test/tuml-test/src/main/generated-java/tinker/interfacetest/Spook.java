...
public class Spook extends BaseTinker implements Spirit, CompositionNode {
	...
	public enum SpookRuntimePropertyEnum implements TumlRuntimeProperty {
		name(true,true,false,"org__tinker__interfacetest__Spook__name",false,false,true,false,1,1,false,false,false,false,true),
