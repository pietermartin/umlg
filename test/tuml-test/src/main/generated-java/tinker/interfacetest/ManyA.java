...
public class ManyA extends BaseTinker implements IManyA, CompositionNode {
	...
	public enum ManyARuntimePropertyEnum implements TumlRuntimeProperty {
		...
		name(true,true,false,"org__tinker__interfacetest__IMany__name",false,false,true,false,1,1,false,false,false,false,true);
		 ...
		 * @param unique 
		 */
		private ManyARuntimePropertyEnum(boolean onePrimitive, boolean controllingSide, boolean composite, String label, boolean oneToOne, boolean oneToMany, boolean manyToOne, boolean manyToMany, int upper, int lower, boolean qualified, boolean inverseQualified, boolean ordered, boolean inverseOrdered, boolean unique) {
