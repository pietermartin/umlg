...
public class Many1 extends BaseTinker implements CompositionNode {
	...
	public List<Qualifier> getQualifierXXXForMany1(Many1 context) {
	...
	public List<Qualifier> getQualifierXXXForMany1List(Many1 context) {
		List<Qualifier> result = new ArrayList<Qualifier>();
		result.add(new Qualifier("listQualifier1", context.getListQualifier1(), Multiplicity.ZERO_TO_MANY));
		return result;
	}
	
	public List<Qualifier> getQualifierXXXForMany2(Many2 context) {
		List<Qualifier> result = new ArrayList<Qualifier>();
		result.add(new Qualifier("qualifier1", context.getQualifier1(), Multiplicity.ONE_TO_ONE));
		return result;
	}
	
	public List<Qualifier> getQualifierXXXForMany2List(Many2 context) {
		List<Qualifier> result = new ArrayList<Qualifier>();
	...
	public List<Qualifier> getQualifiers(TumlRuntimeProperty tumlRuntimeProperty, TinkerNode node) {
		...
		if ( runtimeProperty != null && result.isEmpty() ) {
			switch ( runtimeProperty ) {
				case many2:
					result = getQualifierXXXForMany2((Many2)node);
				break;
			
				case many2List:
					result = getQualifierXXXForMany2List((Many2)node);
				break;
	...
	public enum Many1RuntimePropertyEnum implements TumlRuntimeProperty {
		...
		name(true,true,false,"org__tinker__qualifiertest__Many1__name",false,false,true,false,1,1,false,false,false,false,true),
