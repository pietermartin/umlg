...
public class AbstractFolder extends BaseTinker implements Hierarchy, TinkerNode {
	...
	public enum AbstractFolderRuntimePropertyEnum implements TumlRuntimeProperty {
		...
		name(true,true,false,"org__tinker__hierarchytest__AbstractFolder__name",false,false,true,false,1,1,false,false,false,false,true);
