...
public class Folder extends AbstractFolder implements CompositionNode {
	...
	public enum FolderRuntimePropertyEnum implements TumlRuntimeProperty {
		parentFolder(false,false,false,"A_<abstractFolder>_<folder>",false,false,true,false,1,1,false,false,false,false,true);
		 ...
		 * @param unique 
		 */
		private FolderRuntimePropertyEnum(boolean onePrimitive, boolean controllingSide, boolean composite, String label, boolean oneToOne, boolean oneToMany, boolean manyToOne, boolean manyToMany, int upper, int lower, boolean qualified, boolean inverseQualified, boolean ordered, boolean inverseOrdered, boolean unique) {
