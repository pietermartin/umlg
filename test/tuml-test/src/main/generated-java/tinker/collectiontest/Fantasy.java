...
public class Fantasy extends BaseTinker implements CompositionNode {
	...
	public enum FantasyRuntimePropertyEnum implements TumlRuntimeProperty {
		name(true,true,false,"org__tinker__collectiontest__Fantasy__name",false,false,true,false,1,1,false,false,false,false,true),
		 ...
		 * @param unique 
		 */
		private FantasyRuntimePropertyEnum(boolean onePrimitive, boolean controllingSide, boolean composite, String label, boolean oneToOne, boolean oneToMany, boolean manyToOne, boolean manyToMany, int upper, int lower, boolean qualified, boolean inverseQualified, boolean ordered, boolean inverseOrdered, boolean unique) {
