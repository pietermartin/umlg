...
public class Dream extends BaseTinker implements CompositionNode {
	...
	public enum DreamRuntimePropertyEnum implements TumlRuntimeProperty {
		...
		name(true,true,false,"org__tinker__collectiontest__Dream__name",false,false,true,false,1,1,false,false,false,false,true);
		 ...
		 * @param unique 
		 */
		private DreamRuntimePropertyEnum(boolean onePrimitive, boolean controllingSide, boolean composite, String label, boolean oneToOne, boolean oneToMany, boolean manyToOne, boolean manyToMany, int upper, int lower, boolean qualified, boolean inverseQualified, boolean ordered, boolean inverseOrdered, boolean unique) {
