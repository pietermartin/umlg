...
public class Nightmare extends BaseTinker implements CompositionNode {
	...
	public enum NightmareRuntimePropertyEnum implements TumlRuntimeProperty {
		name(true,true,false,"org__tinker__collectiontest__Nightmare__name",false,false,true,false,1,1,false,false,false,false,true),
		god(false,false,false,"A_<god>_<nightmare>",false,false,true,false,1,1,false,true,false,false,true),
		nameNonUnique(true,true,false,"org__tinker__collectiontest__Nightmare__nameNonUnique",false,false,true,false,1,1,false,false,false,false,true),
