...
public class Hand extends BaseTinker implements CompositionNode {
	...
	public enum HandRuntimePropertyEnum implements TumlRuntimeProperty {
		left(true,true,false,"org__tinker__collectiontest__Hand__left",false,false,true,false,1,1,false,false,false,false,true),
		god(false,false,false,"A_<god>_<hand>",false,false,true,false,1,1,false,false,false,true,true),
		name(true,true,false,"org__tinker__collectiontest__Hand__name",false,false,true,false,1,1,false,false,false,false,true);
		 ...
		 * @param unique 
		 */
		private HandRuntimePropertyEnum(boolean onePrimitive, boolean controllingSide, boolean composite, String label, boolean oneToOne, boolean oneToMany, boolean manyToOne, boolean manyToMany, int upper, int lower, boolean qualified, boolean inverseQualified, boolean ordered, boolean inverseOrdered, boolean unique) {
