...
public class Demon extends BaseTinker implements CompositionNode {
	...
	public enum DemonRuntimePropertyEnum implements TumlRuntimeProperty {
		universe(false,false,false,"A_<universe>_<demon>",false,false,true,false,1,1,false,false,false,false,true),
		god(false,false,false,"A_<god>_<demon>",false,false,true,false,1,1,false,false,false,false,true),
		name(true,true,false,"tuml-test__org__tuml__concretetest__Demon__name",false,false,true,false,1,1,false,false,false,false,true);
		 ...
		 * @param unique 
		 */
		private DemonRuntimePropertyEnum(boolean onePrimitive, boolean controllingSide, boolean composite, String label, boolean oneToOne, boolean oneToMany, boolean manyToOne, boolean manyToMany, int upper, int lower, boolean qualified, boolean inverseQualified, boolean ordered, boolean inverseOrdered, boolean unique) {
