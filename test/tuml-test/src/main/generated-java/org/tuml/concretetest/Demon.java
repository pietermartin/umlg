...
public class Demon extends BaseTuml implements CompositionNode {
	...
	public List<Qualifier> getQualifiers(TumlRuntimeProperty tumlRuntimeProperty, TumlNode node) {
		...
		DemonRuntimePropertyEnum runtimeProperty = DemonRuntimePropertyEnum.fromLabel(tumlRuntimeProperty.getLabel());
	...
	static public enum DemonRuntimePropertyEnum implements TumlRuntimeProperty {
		universe(false,false,false,false,"A_<universe>_<demon>",false,false,true,false,1,1,false,false,false,false,true,"{\"universe\": {\"onePrimitive\": false, \"manyPrimitive\": false, \"controllingSide\": false, \"composite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"label\": \"A_<universe>_<demon>\", \"qualified\": false, \"inverseQualified\": false, \"inverseOrdered\": false, \"unique\": true}}"),
		name(true,false,true,false,"tumltest__org__tuml__concretetest__Demon__name",false,false,true,false,1,1,false,false,false,false,true,"{\"name\": {\"onePrimitive\": true, \"manyPrimitive\": false, \"controllingSide\": true, \"composite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"label\": \"tumltest__org__tuml__concretetest__Demon__name\", \"qualified\": false, \"inverseQualified\": false, \"inverseOrdered\": false, \"unique\": true}}"),
		god(false,false,false,false,"A_<god>_<demon>",false,false,true,false,1,1,false,false,false,false,true,"{\"god\": {\"onePrimitive\": false, \"manyPrimitive\": false, \"controllingSide\": false, \"composite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"label\": \"A_<god>_<demon>\", \"qualified\": false, \"inverseQualified\": false, \"inverseOrdered\": false, \"unique\": true}}");
		...
		static public String asJson() {
			StringBuilder sb = new StringBuilder();;
			sb.append("{\"Demon\": [");
			sb.append(DemonRuntimePropertyEnum.universe.toJson());
			sb.append(",");
			sb.append(DemonRuntimePropertyEnum.name.toJson());
			sb.append(",");
			sb.append(DemonRuntimePropertyEnum.god.toJson());
			sb.append("]}");
			return sb.toString();
		}
