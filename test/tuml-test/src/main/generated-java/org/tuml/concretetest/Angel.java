...
public class Angel extends BaseTuml implements CompositionNode {
	...
	public void setUniverse(Universe universe) {
		if ( universe != null ) {
			universe.clearAngel();
			universe.initialiseProperty(UniverseRuntimePropertyEnum.angel);
		}
		clearUniverse();
	...
	static public enum AngelRuntimePropertyEnum implements TumlRuntimeProperty {
		name(true,false,true,false,"tumltest__org__tuml__concretetest__Angel__name",false,false,true,false,1,1,false,false,false,false,true,"{\"name\": {\"onePrimitive\": true, \"manyPrimitive\": false, \"controllingSide\": true, \"composite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"label\": \"tumltest__org__tuml__concretetest__Angel__name\", \"qualified\": false, \"inverseQualified\": false, \"inverseOrdered\": false, \"unique\": true}}"),
		universe(false,false,true,false,"A_<universe>_<angel>",true,false,false,false,1,1,false,false,false,false,true,"{\"universe\": {\"onePrimitive\": false, \"manyPrimitive\": false, \"controllingSide\": true, \"composite\": false, \"oneToOne\": true, \"oneToMany\": false, \"manyToOne\": false, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"label\": \"A_<universe>_<angel>\", \"qualified\": false, \"inverseQualified\": false, \"inverseOrdered\": false, \"unique\": true}}"),
		god(false,false,false,false,"A_<god>_<angel>",false,false,true,false,1,1,false,false,false,false,true,"{\"god\": {\"onePrimitive\": false, \"manyPrimitive\": false, \"controllingSide\": false, \"composite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"label\": \"A_<god>_<angel>\", \"qualified\": false, \"inverseQualified\": false, \"inverseOrdered\": false, \"unique\": true}}");
		 ...
		 * @param json 
		 */
		private AngelRuntimePropertyEnum(boolean onePrimitive, boolean manyPrimitive, boolean controllingSide, boolean composite, String label, boolean oneToOne, boolean oneToMany, boolean manyToOne, boolean manyToMany, int upper, int lower, boolean qualified, boolean inverseQualified, boolean ordered, boolean inverseOrdered, boolean unique, String json) {
		...
		static public String asJson() {
			StringBuilder sb = new StringBuilder();;
			sb.append("{\"Angel\": [");
			sb.append(AngelRuntimePropertyEnum.name.toJson());
			sb.append(",");
			sb.append(AngelRuntimePropertyEnum.universe.toJson());
			sb.append(",");
			sb.append(AngelRuntimePropertyEnum.god.toJson());
			sb.append("]}");
			return sb.toString();
		}
