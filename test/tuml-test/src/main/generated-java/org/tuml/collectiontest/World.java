...
public class World extends BaseTuml implements CompositionNode {
	...
	static public enum WorldRuntimePropertyEnum implements TumlRuntimeProperty {
		god(false,false,false,false,"A_<god>_<world>",false,false,true,false,1,1,false,false,false,true,true,"{\"god\": {\"onePrimitive\": false, \"manyPrimitive\": false, \"controllingSide\": false, \"composite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"label\": \"A_<god>_<world>\", \"qualified\": false, \"inverseQualified\": false, \"inverseOrdered\": false, \"unique\": true}}"),
		name(true,false,true,false,"tumltest__org__tuml__collectiontest__World__name",false,false,true,false,1,1,false,false,false,false,true,"{\"name\": {\"onePrimitive\": true, \"manyPrimitive\": false, \"controllingSide\": true, \"composite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"label\": \"tumltest__org__tuml__collectiontest__World__name\", \"qualified\": false, \"inverseQualified\": false, \"inverseOrdered\": false, \"unique\": true}}");
		 ...
		 * @param json 
		 */
		private WorldRuntimePropertyEnum(boolean onePrimitive, boolean manyPrimitive, boolean controllingSide, boolean composite, String label, boolean oneToOne, boolean oneToMany, boolean manyToOne, boolean manyToMany, int upper, int lower, boolean qualified, boolean inverseQualified, boolean ordered, boolean inverseOrdered, boolean unique, String json) {
		...
		static public String asJson() {
			StringBuilder sb = new StringBuilder();;
			sb.append("{\"World\": [");
			sb.append(WorldRuntimePropertyEnum.god.toJson());
			sb.append(",");
			sb.append(WorldRuntimePropertyEnum.name.toJson());
			sb.append("]}");
			return sb.toString();
		}
