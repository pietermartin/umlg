...
public class Finger extends BaseTuml implements CompositionNode {
	...
	static public enum FingerRuntimePropertyEnum implements TumlRuntimeProperty {
		...
		name(true,false,true,false,"tumltest__org__tuml__collectiontest__Finger__name",false,false,true,false,1,1,false,false,false,false,true,"{\"name\": {\"onePrimitive\": true, \"manyPrimitive\": false, \"controllingSide\": true, \"composite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"label\": \"tumltest__org__tuml__collectiontest__Finger__name\", \"qualified\": false, \"inverseQualified\": false, \"inverseOrdered\": false, \"unique\": true}}");
