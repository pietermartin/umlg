...
public class NonNavigableOne extends BaseTuml implements CompositionNode {
	...
	public List<Qualifier> getQualifiers(TumlRuntimeProperty tumlRuntimeProperty, TumlNode node) {
		...
		NonNavigableOneRuntimePropertyEnum runtimeProperty = NonNavigableOneRuntimePropertyEnum.fromLabel(tumlRuntimeProperty.getLabel());
	...
	public void setUniverse(Universe universe) {
		if ( universe != null ) {
			...
			universe.initialiseProperty(UniverseRuntimePropertyEnum.nonNavigableOne);
		}
		clearUniverse();
	...
	static public enum NonNavigableOneRuntimePropertyEnum implements TumlRuntimeProperty {
		god(false,false,false,false,"A_<god>_<nonNavigableOne>",false,false,true,false,1,1,false,false,false,false,true,"{\"god\": {\"onePrimitive\": false, \"manyPrimitive\": false, \"controllingSide\": false, \"composite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"label\": \"A_<god>_<nonNavigableOne>\", \"qualified\": false, \"inverseQualified\": false, \"inverseOrdered\": false, \"unique\": true}}"),
		name(true,false,true,false,"tumltest__org__tuml__navigability__NonNavigableOne__name",false,false,true,false,1,1,false,false,false,false,true,"{\"name\": {\"onePrimitive\": true, \"manyPrimitive\": false, \"controllingSide\": true, \"composite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"label\": \"tumltest__org__tuml__navigability__NonNavigableOne__name\", \"qualified\": false, \"inverseQualified\": false, \"inverseOrdered\": false, \"unique\": true}}"),
		universe(false,false,true,false,"A_<universe>_<nonNavigableOne>",true,false,false,false,1,1,false,false,false,false,true,"{\"universe\": {\"onePrimitive\": false, \"manyPrimitive\": false, \"controllingSide\": true, \"composite\": false, \"oneToOne\": true, \"oneToMany\": false, \"manyToOne\": false, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"label\": \"A_<universe>_<nonNavigableOne>\", \"qualified\": false, \"inverseQualified\": false, \"inverseOrdered\": false, \"unique\": true}}");
		 ...
		 * @param json 
		 */
		private NonNavigableOneRuntimePropertyEnum(boolean onePrimitive, boolean manyPrimitive, boolean controllingSide, boolean composite, String label, boolean oneToOne, boolean oneToMany, boolean manyToOne, boolean manyToMany, int upper, int lower, boolean qualified, boolean inverseQualified, boolean ordered, boolean inverseOrdered, boolean unique, String json) {
		...
		static public String asJson() {
			StringBuilder sb = new StringBuilder();;
			sb.append("{\"NonNavigableOne\": [");
			sb.append(NonNavigableOneRuntimePropertyEnum.god.toJson());
			sb.append(",");
			sb.append(NonNavigableOneRuntimePropertyEnum.name.toJson());
			sb.append(",");
			sb.append(NonNavigableOneRuntimePropertyEnum.universe.toJson());
			sb.append("]}");
			return sb.toString();
		}
