...
public class Space extends BaseTuml implements CompositionNode {
	...
	public List<Qualifier> getQualifiers(TumlRuntimeProperty tumlRuntimeProperty, TumlNode node) {
		...
		SpaceRuntimePropertyEnum runtimeProperty = SpaceRuntimePropertyEnum.fromLabel(tumlRuntimeProperty.getLabel());
	...
	public void setSpaceTime(SpaceTime spaceTime) {
		if ( spaceTime != null ) {
			spaceTime.clearSpace();
			spaceTime.initialiseProperty(SpaceTimeRuntimePropertyEnum.space);
		}
		clearSpaceTime();
	...
	static public enum SpaceRuntimePropertyEnum implements TumlRuntimeProperty {
		spaceTime(false,false,false,false,"A_<spaceTime>_<space>",true,false,false,false,1,1,false,false,false,false,true,"{\"spaceTime\": {\"onePrimitive\": false, \"manyPrimitive\": false, \"controllingSide\": false, \"composite\": false, \"oneToOne\": true, \"oneToMany\": false, \"manyToOne\": false, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"label\": \"A_<spaceTime>_<space>\", \"qualified\": false, \"inverseQualified\": false, \"inverseOrdered\": false, \"unique\": true}}"),
		name(true,false,true,false,"tumltest__org__tuml__componenttest__Space__name",false,false,true,false,1,1,false,false,false,false,true,"{\"name\": {\"onePrimitive\": true, \"manyPrimitive\": false, \"controllingSide\": true, \"composite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"label\": \"tumltest__org__tuml__componenttest__Space__name\", \"qualified\": false, \"inverseQualified\": false, \"inverseOrdered\": false, \"unique\": true}}");
		 ...
		 * @param json 
		 */
		private SpaceRuntimePropertyEnum(boolean onePrimitive, boolean manyPrimitive, boolean controllingSide, boolean composite, String label, boolean oneToOne, boolean oneToMany, boolean manyToOne, boolean manyToMany, int upper, int lower, boolean qualified, boolean inverseQualified, boolean ordered, boolean inverseOrdered, boolean unique, String json) {
		...
		static public String asJson() {
			StringBuilder sb = new StringBuilder();;
			sb.append("{\"Space\": [");
			sb.append(SpaceRuntimePropertyEnum.spaceTime.toJson());
			sb.append(",");
			sb.append(SpaceRuntimePropertyEnum.name.toJson());
			sb.append("]}");
			return sb.toString();
		}
