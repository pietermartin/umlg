...
public class Space extends BaseTinker implements CompositionNode {
	...
	public enum SpaceRuntimePropertyEnum implements TumlRuntimeProperty {
		name(true,true,false,"tuml-test__org__tuml__componenttest__Space__name",false,false,true,false,1,1,false,false,false,false,true),
		spaceTime(false,false,false,"A_<spaceTime>_<space>",true,false,false,false,1,1,false,false,false,false,true);
		 ...
		 * @param unique 
		 */
		private SpaceRuntimePropertyEnum(boolean onePrimitive, boolean controllingSide, boolean composite, String label, boolean oneToOne, boolean oneToMany, boolean manyToOne, boolean manyToMany, int upper, int lower, boolean qualified, boolean inverseQualified, boolean ordered, boolean inverseOrdered, boolean unique) {
