...
public interface IMany extends CompositionNode {
	...
	public enum IManyRuntimePropertyEnum implements TumlRuntimeProperty {
		...
		private String json;
		/**
		 * constructor for IManyRuntimePropertyEnum
		 * 
		 * @param onePrimitive 
		 * @param manyPrimitive 
		 ...
		 * @param json 
		 */
		private IManyRuntimePropertyEnum(boolean onePrimitive, boolean manyPrimitive, boolean controllingSide, boolean composite, String label, boolean oneToOne, boolean oneToMany, boolean manyToOne, boolean manyToMany, int upper, int lower, boolean qualified, boolean inverseQualified, boolean ordered, boolean inverseOrdered, boolean unique, String json) {
		...
		static public String asJson() {
			...
			sb.append("[");
			sb.append(IManyRuntimePropertyEnum.god.toJson());
			sb.append(",");
			sb.append(IManyRuntimePropertyEnum.name.toJson());
			sb.append(",");
			sb.append("]");
			return sb.toString();
		}
		
		static public IManyRuntimePropertyEnum fromLabel(String label) {
