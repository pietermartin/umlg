...
public class Phantom extends BaseTuml implements CompositionNode, Spirit {
	...
	public List<Qualifier> getQualifiers(TumlRuntimeProperty tumlRuntimeProperty, TumlNode node) {
		...
		PhantomRuntimePropertyEnum runtimeProperty = PhantomRuntimePropertyEnum.fromLabel(tumlRuntimeProperty.getLabel());
	...
	static public enum PhantomRuntimePropertyEnum implements TumlRuntimeProperty {
		name(true,false,true,false,"tumltest__org__tuml__interfacetest__Phantom__name",false,false,true,false,1,1,false,false,false,false,true,"{\"name\": {\"onePrimitive\": true, \"manyPrimitive\": false, \"controllingSide\": true, \"composite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"label\": \"tumltest__org__tuml__interfacetest__Phantom__name\", \"qualified\": false, \"inverseQualified\": false, \"inverseOrdered\": false, \"unique\": true}}"),
		god(false,false,false,false,"A_<god>_<spirit>",false,false,true,false,1,1,false,false,false,false,true,"{\"god\": {\"onePrimitive\": false, \"manyPrimitive\": false, \"controllingSide\": false, \"composite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"label\": \"A_<god>_<spirit>\", \"qualified\": false, \"inverseQualified\": false, \"inverseOrdered\": false, \"unique\": true}}");
		...
		static public String asJson() {
			StringBuilder sb = new StringBuilder();;
			sb.append("{\"Phantom\": [");
			sb.append(PhantomRuntimePropertyEnum.name.toJson());
			sb.append(",");
			sb.append(PhantomRuntimePropertyEnum.god.toJson());
			sb.append("]}");
			return sb.toString();
		}
