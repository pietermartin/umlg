...
abstract public class AbstractSpecies extends BaseTuml implements CompositionNode {
	 ...
	 * <pre>
	 * package tumltest::org::tuml::inheritencetest
	 *     context AbstractSpecies::name : String
	 *     derive: 'thisisdodge'
	 * endpackage
	 * </pre>
	 */
	...
	static public enum AbstractSpeciesRuntimePropertyEnum implements TumlRuntimeProperty {
		name(true,false,true,false,"tumltest__org__tuml__inheritencetest__AbstractSpecies__name",false,false,true,false,1,1,false,false,false,false,true,"{\"name\": {\"onePrimitive\": true, \"manyPrimitive\": false, \"controllingSide\": true, \"composite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"label\": \"tumltest__org__tuml__inheritencetest__AbstractSpecies__name\", \"qualified\": false, \"inverseQualified\": false, \"inverseOrdered\": false, \"unique\": true}}"),
		god(false,false,false,false,"A_<god>_<abstractSpecies>",false,false,true,false,1,1,false,false,false,false,true,"{\"god\": {\"onePrimitive\": false, \"manyPrimitive\": false, \"controllingSide\": false, \"composite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"label\": \"A_<god>_<abstractSpecies>\", \"qualified\": false, \"inverseQualified\": false, \"inverseOrdered\": false, \"unique\": true}}");
		 ...
		 * @param json 
		 */
		private AbstractSpeciesRuntimePropertyEnum(boolean onePrimitive, boolean manyPrimitive, boolean controllingSide, boolean composite, String label, boolean oneToOne, boolean oneToMany, boolean manyToOne, boolean manyToMany, int upper, int lower, boolean qualified, boolean inverseQualified, boolean ordered, boolean inverseOrdered, boolean unique, String json) {
		...
		static public String asJson() {
			StringBuilder sb = new StringBuilder();;
			sb.append("{\"AbstractSpecies\": [");
			sb.append(AbstractSpeciesRuntimePropertyEnum.name.toJson());
			sb.append(",");
			sb.append(AbstractSpeciesRuntimePropertyEnum.god.toJson());
			sb.append("]}");
			return sb.toString();
		}
