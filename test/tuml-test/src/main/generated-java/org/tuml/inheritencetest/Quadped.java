...
public class Quadped extends Mamal implements CompositionNode {
	...
	static public enum QuadpedRuntimePropertyEnum implements TumlRuntimeProperty {
	;
		 ...
		 * @param json 
		 */
		private QuadpedRuntimePropertyEnum(boolean onePrimitive, boolean manyPrimitive, boolean controllingSide, boolean composite, String label, boolean oneToOne, boolean oneToMany, boolean manyToOne, boolean manyToMany, int upper, int lower, boolean qualified, boolean inverseQualified, boolean ordered, boolean inverseOrdered, boolean unique, String json) {
