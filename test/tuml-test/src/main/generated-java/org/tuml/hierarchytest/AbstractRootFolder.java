...
abstract public class AbstractRootFolder extends AbstractFolder implements TumlNode {
	 ...
	 * context AbstractRootFolder::getParent() : Hierarchy
	 * body: null
	 * endpackage
	 * </pre>
	 */
	 ...
	 * <pre>
	 * package tumltest::org::tuml::hierarchytest
	 * context AbstractRootFolder::isRoot() : Boolean
	 * body: true
	 * endpackage
	 * </pre>
	 */
	...
	static public enum AbstractRootFolderRuntimePropertyEnum implements TumlRuntimeProperty {
	;
		 ...
		 * @param json 
		 */
		private AbstractRootFolderRuntimePropertyEnum(boolean onePrimitive, boolean manyPrimitive, boolean controllingSide, boolean composite, String label, boolean oneToOne, boolean oneToMany, boolean manyToOne, boolean manyToMany, int upper, int lower, boolean qualified, boolean inverseQualified, boolean ordered, boolean inverseOrdered, boolean unique, String json) {
