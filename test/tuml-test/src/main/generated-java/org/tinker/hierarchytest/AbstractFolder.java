...
public class AbstractFolder extends BaseTinker implements CompositionNode {
	...
	public void initialiseProperties() {
		this.name =  new TinkerSetImpl<String>(this, "org__tinker__hierarchytest__AbstractFolder__name", true, new TumlRuntimePropertyImpl(false,false,true,false,1,1), false);
		this.childFolder =  new TinkerSetImpl<Folder>(this, "A_<abstractFolder>_<folder>", true, new TumlRuntimePropertyImpl(false,true,false,false,0,-1), true);
	}
