...
public class Fantasy extends BaseTinker implements CompositionNode {
	...
	public void addToGod(God god) {
		if ( god != null ) {
			god.z_internalRemoveFromFantasy(god.getFantasy());
			god.z_internalAddToFantasy(this);
	...
	public void initialiseProperties() {
		this.name =  new TinkerSetImpl<String>(this, "org__tinker__collectiontest__Fantasy__name", true, new TumlRuntimePropertyImpl(false,false,true,false,1,1), false);
	}
