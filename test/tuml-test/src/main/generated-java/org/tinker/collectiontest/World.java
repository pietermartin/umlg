...
public class World extends BaseTinker implements CompositionNode {
	...
	public void addToGod(God god) {
		if ( god != null ) {
			god.z_internalRemoveFromWorld(god.getWorld());
			god.z_internalAddToWorld(this);
	...
	public void initialiseProperties() {
		this.name =  new TinkerSetImpl<String>(this, "org__tinker__collectiontest__World__name", true, new TumlRuntimePropertyImpl(false,false,true,false,1,1), false);
	}
