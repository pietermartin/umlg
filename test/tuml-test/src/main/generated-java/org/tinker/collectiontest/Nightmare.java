...
public class Nightmare extends BaseTinker implements CompositionNode {
	...
	public void initialiseProperties() {
		this.name =  new TinkerSetImpl<String>(this, "org__tinker__collectiontest__Nightmare__name", true, new TinkerMultiplicityImpl(false,false,true,false,1,1), false);
		this.nameNonUnique =  new TinkerSetImpl<String>(this, "org__tinker__collectiontest__Nightmare__nameNonUnique", true, new TinkerMultiplicityImpl(false,false,true,false,1,1), false);
	}
