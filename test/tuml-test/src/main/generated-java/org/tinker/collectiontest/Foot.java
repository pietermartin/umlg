...
public class Foot extends BaseTinker implements CompositionNode {
	...
	public void addToGod(God god) {
		if ( god != null ) {
			god.z_internalRemoveFromFoot(god.getFoot());
			god.z_internalAddToFoot(this);
	...
	public void initialiseProperties() {
		this.name =  new TinkerSetImpl<String>(this, "org__tinker__collectiontest__Foot__name", true, new TumlRuntimePropertyImpl(false,false,true,false,1,1), false);
	}
