...
public class Dream extends BaseTinker implements CompositionNode {
	...
	public void addToGod(God god) {
		if ( god != null ) {
			god.z_internalRemoveFromDream(god.getDream());
			god.z_internalAddToDream(this);
	...
	public void initialiseProperties() {
		this.name =  new TinkerSetImpl<String>(this, "org__tinker__collectiontest__Dream__name", true, new TumlRuntimePropertyImpl(false,false,true,false,1,1), false);
	}
