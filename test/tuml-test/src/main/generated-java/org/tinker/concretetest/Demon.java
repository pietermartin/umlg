...
public class Demon extends BaseTinker implements CompositionNode {
	...
	public void addToGod(God god) {
		if ( god != null ) {
			god.z_internalRemoveFromDemon(god.getDemon());
			god.z_internalAddToDemon(this);
	...
	public void addToUniverse(Universe universe) {
		if ( universe != null ) {
			universe.z_internalRemoveFromDemon(universe.getDemon());
			universe.z_internalAddToDemon(this);
	...
	public void initialiseProperties() {
		this.name =  new TinkerSetImpl<String>(this, "org__tinker__concretetest__Demon__name", true, new TumlRuntimePropertyImpl(false,false,true,false,1,1), false);
	}
