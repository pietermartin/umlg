...
public class Many2 extends BaseTinker implements CompositionNode {
	...
	public enum Many2RuntimePropertyEnum implements TumlRuntimeProperty {
		god(false,false,false,"A_<god>_<many2>",false,false,true,false,1,1),
		many1UnqualifiedList(false,true,false,"A_<many1>_<many2>_3",false,false,false,true,-1,0),
		many1List(false,true,false,"A_<many1>_<many2>_2",false,false,false,true,-1,0),
		name(true,true,false,"org__tinker__qualifiertest__Many2__name",false,false,true,false,1,1),
		many1(false,true,false,"A_<many1>_<many2>",false,false,false,true,-1,0);
		 ...
		 * @param lower 
		 */
		private Many2RuntimePropertyEnum(boolean onePrimitive, boolean controllingSide, boolean composite, String label, boolean oneToOne, boolean oneToMany, boolean manyToOne, boolean manyToMany, int upper, int lower) {
