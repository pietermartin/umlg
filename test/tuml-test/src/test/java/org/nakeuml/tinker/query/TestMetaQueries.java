...
public class TestMetaQueries extends BaseLocalDbTest {
    ...
    public void testClassQuery() {
        ...
        DreamMeta.INSTANCE.addToClassQuery(q1);
        ...
        DreamMeta.INSTANCE.addToClassQuery(q2);
        ...
        Assert.assertEquals(2, DreamMeta.INSTANCE.getClassQuery().size());
