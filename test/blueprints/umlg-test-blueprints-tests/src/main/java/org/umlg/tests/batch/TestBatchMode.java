...
//        Assert.assertEquals(100000, Universe.allInstances().size());
//        Assert.assertEquals(100000, SpaceTime.allInstances().size());
//        Assert.assertEquals(100000, Space.allInstances().size());
//        Assert.assertEquals(100000, Time.allInstances().size());
//        Assert.assertEquals(100000, god.getUniverse().size());
