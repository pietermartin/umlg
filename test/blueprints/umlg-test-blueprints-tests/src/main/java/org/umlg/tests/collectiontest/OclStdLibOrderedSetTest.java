...
public class OclStdLibOrderedSetTest extends BaseLocalDbTest {
    ...
    public void testInsertAt2() {
        ...
        UmlgOrderedSet<OrderedSetTest> orderedSetTests = orderedSetRoot.getOrderedSetTest().insertAt(3, orderedSetTest5);
    ...
    public void testInsertSubOrderedSet() {
        ...
        UmlgOrderedSet<OrderedSetTest> orderedSetTests = orderedSetRoot.getOrderedSetTest().subOrderedSet(2, 3);
