...
//    @Test
    public void testTitanInsertVertexPerformance() {
        File f = new File(System.getProperty("java.io.tmpdir") + System.lineSeparator() + "titan-performance");
        if (f.exists()) {
            f.delete();
        }
        f.mkdir();
...
//    @Test
    public void testTitanPerformance() {
        File f = new File(System.getProperty("java.io.tmpdir") + System.lineSeparator() + "neo4j-performance");
        if (f.exists()) {
            f.delete();
        }
        f.mkdir();
