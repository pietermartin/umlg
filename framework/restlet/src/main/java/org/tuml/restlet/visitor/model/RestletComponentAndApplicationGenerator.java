...
public class RestletComponentAndApplicationGenerator extends BaseVisitor implements Visitor<Model> {
    ...
    private void addApplicationInboundRootMethod(Model model, OJAnnotatedClass application) {
        ...
        createInboundRoot.getBody().addToStatements("Directory slickgrid = new Directory(getContext(), \"file:///home/pieter/Downloads/tuml/runtime/runtime-jquery/src/main/javascript/javascript\")");
        ...
        createInboundRoot.getBody().addToStatements("Directory css = new Directory(getContext(), \"file:///home/pieter/Downloads/tuml/runtime/runtime-jquery/src/main/javascript/css\")");
