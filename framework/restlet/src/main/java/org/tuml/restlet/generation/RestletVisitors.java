...
import org.tuml.restlet.visitor.clazz.AddSelfIdAndUriLiteralsToRootRuntimeEnum;
import org.tuml.restlet.visitor.clazz.AddSelfIdAndUriLiteralsToRuntimeEnum;
...
public class RestletVisitors {
	...
	public static List<Visitor<?>> getDefaultJavaVisitors() {
		...
		result.add(new AddSelfIdAndUriLiteralsToRuntimeEnum(Workspace.INSTANCE));
		result.add(new AddTumlUriFieldToRuntimePropertyEnum(Workspace.INSTANCE));
		result.add(new AddSelfIdAndUriLiteralsToRootRuntimeEnum(Workspace.INSTANCE));
