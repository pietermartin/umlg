...
public class InterfaceRuntimePropertyImplementorVisitor extends BaseVisitor implements Visitor<Interface> {
	...
	// private void addTumlRuntimePropertyEnum(OJAnnotatedClass annotatedClass,
	// Interface inf) {
	...
	//
	// OJAnnotatedOperation fromLabel = new OJAnnotatedOperation("fromLabel",
	// new OJPathName(TumlClassOperations.propertyEnumName(inf)));
	// fromLabel.addParam("label", new OJPathName("String"));
	// fromLabel.setStatic(true);
	// ojEnum.addToOperations(fromLabel);
	//
	// OJAnnotatedOperation isValid = new OJAnnotatedOperation("isValid", new
	// OJPathName("boolean"));
	...
	//
	// OJAnnotatedOperation toJson = new OJAnnotatedOperation("toJson", new
	// OJPathName("String"));
	...
	//
	// OJAnnotatedOperation asJson = new OJAnnotatedOperation("asJson", new
	// OJPathName("String"));
	...
	// TumlInterfaceOperations.getAllProperties(inf);
	// for (Property p : allProperties) {
	// PropertyWrapper pWrap = new PropertyWrapper(p);
	// if (!(pWrap.isDerived() || pWrap.isDerivedUnion())) {
	//
	// asJson.getBody().addToStatements("sb.append(" + ojEnum.getName() + "." +
	// pWrap.fieldname() + ".toJson())");
	// if (count != allProperties.size()) {
	// asJson.getBody().addToStatements("sb.append(\",\")");
	// }
	//
	// OJIfStatement ifLabelEquals = new OJIfStatement(pWrap.fieldname() +
	...
	// propertyOnePrimitiveField.setInitExp(Boolean.toString(pWrap.isPrimitive()
	// && pWrap.isManyToOne()));
	...
	// propertyManyPrimitiveField.setInitExp(Boolean.toString(pWrap.isPrimitive()
	// && pWrap.isMany()));
	...
	// sb.append(", ");
	// sb.append("\\\"label\\\": \\");
	// sb.append(propertyLabelField.getInitExp().subSequence(0,
	// propertyLabelField.getInitExp().length() - 1));
	// sb.append("\\\", ");
	// sb.append("\\\"qualified\\\": ");
