...
public class NonNavigableOne extends BaseTinker implements CompositionNode {
	...
	public void initialiseProperties() {
		this.name =  new TinkerSetImpl<String>(this, "org__tinker__navigability__NonNavigableOne__name", true, new TinkerMultiplicityImpl(false,false,true,false,1,1), false);
	}
